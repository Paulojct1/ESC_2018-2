    ...
    if command == "neg" or command == "not":
        ...
        if command == "add":
            ...
            if command == "eq":
                ...
                output.append("D=D-M\n")
                output.append("@TRUE_" + jumpDict["TRUE"] + "\n")
                output.append("D; JEQ\n")
            ...
            output.append("D=0\n")
            output.append("@CONTINUE_" + jumpDict["CONTINUE"] + "\n") 
            output.append("0; JMP\n")
            output.append("(TRUE_" + jumpDict["TRUE"] + ")\n")
            output.append("D=-1\n")
            output.append("(CONTINUE_" + jumpDict["CONTINUE"] + ")\n")

            jumpDict["TRUE"] = str(int(jumpDict["TRUE"]) + 1)
            jumpDict["CONTINUE"] = str(int(jumpDict["CONTINUE"]) + 1)
